...
const images = [
  "https://api.playmo.mn/storage/images/media/cover/md/mOTXKUfveKmBZ4UITdumKUxwOz39jtkJpRqZwhD2.jpg",
...
export default function ScrollNine() {
  return (
    <div class="relative rounded-xl overflow-auto ">
      <div class="text-3xl font-bold p-2">Монгол цуврал</div>
